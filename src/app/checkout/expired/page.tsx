...
function CheckoutExpiredContent() {
  ...
  useEffect(() => {
    tryOpenMobileApp('checkout/expired')
  }, [])
    ...
    <Layout>
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-8">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-br from-yellow-50 to-amber-50 px-8 py-10 text-center border-b border-yellow-200">
          ...
          <div className="px-8 py-6 space-y-4">
            <p className="text-gray-600 text-center">
              Não se preocupe! Seu carrinho ainda está salvo. Você pode iniciar um novo pagamento.
            </p>
